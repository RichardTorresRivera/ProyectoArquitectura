/*
  OLED_I2C.h - Multi-platform library support for 128x32 and 128x64 pixel SSD1306 OLEDs
...
class OLED
{
	public:
		...
		void	clrFillCircle(int x, int y, int radius);
